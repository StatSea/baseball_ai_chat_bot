...
BASE_PATH = Path(file).resolve().parent
...
return {"ok": True, "replay": meta.dict}
...
REPLAY_STATE[game_id] = meta
ensure_replay_task(game_id)
return {"ok": True, "replay": meta.dict, "state": build_state(game_id)}
...
REPLAY_STATE[game_id] = ReplayMeta(index=0, running=False, interval=10.0)
ensure_replay_task(game_id)
return {"ok": True, "replay": REPLAY_STATE[game_id].dict}
